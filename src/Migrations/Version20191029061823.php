 ...
 */
final class Version20191029061823 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE categories ADD nom VARCHAR(255) NOT NULL, DROP label');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE categories ADD label VARCHAR(100) NOT NULL COLLATE utf8mb4_unicode_ci, DROP nom');
    }
}
